...
typedef union
{
    ...
    RDB_ROAD_POS_t                  roadPos;                       /**< detailed road position of a given entity      maybe usefull~                      @msgid RDB_PKG_ID_ROAD_POS                  */
    ...
    RDB_OBJECT_STATE_t              objectState;                   /**< info about an arbitrary object's state        maybe usefull~                      @msgid RDB_PKG_ID_OBJECT_STATE              */
